...
Он использует фиксированные параметры, подобранные как универсальный компромисс для большинства изображений.
...
Подробная инструкция пользователя: [instruction.pdf](instruction.pdf).

Видеодемонстрация работы сервиса: [demo_video.mp4](demo_video.mp4).
...
- Расширение и усовершенствование постобработки для более тонкой компенсации артефактов нейросетевого восстановления и адаптации финального результата под различные типы изображений.
